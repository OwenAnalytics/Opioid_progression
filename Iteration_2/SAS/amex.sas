...
libname AMEX '/ace/AMEX_2018/Data';
libname library '/ace/AMEX_2018/SAS/library';
...
data amex.elig;
  infile "/ace/AMEX_2018/Data/amex_opioid_elig_1212278.csv" delimiter = ',' missover dsd firstobs = 2 lrecl = 400;
...
data library.opioid_vs_&hedis_yr;
  infile "/ace/AMEX_2018/SAS/library/opioid_value_sets_2017.csv" dlm = ',' missover dsd firstobs = 2;
...
proc freq data=amex.elig_trim;
  ...
  tables age_years sex state_cd / missprint;
run;
...
%macro exp(dset);
  proc export data=amex.&dset
    outfile = "/ace/AMEX_2018/Data/&dset..csv"
    dbms = dlm replace;
    delimiter = ',';
    putnames = yes;
  run;
