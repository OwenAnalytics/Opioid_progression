...
** trvlapp3152: /home/u0112740/opioid/scripts/amex.sas **;
** N. Ridenour 07.23.18                                **;

libname amex wpd    '/data/amex';
...
data amex.elig;
  infile "/data/amex/elig_amex.csv" dlm = ',' missover dsd firstobs = 2 lrecl = 400;
  informat 'elig_start_dt'n MMDDYY10.;
  format 'elig_start_dt'n mmddyy10. enrolid $20. elig_start_dt business_unit_cd plan_cd $35. mdst_plan_model_cd $30. family_id $15. plan $75. table $12.;
...
data amex.claims;
  infile "/data/amex/clms_amex.csv" dlm = ',' missover dsd firstobs = 2 lrecl = 700;
  ...
  format 'svcdate'n 'tsvcdat'n 'paiddt'n MMDDYY10. enrolid $20. claim_id mdst_prov_type $30. ndcnum $11. dtl_ther_class_cd npi_id $10. 
		 prov_id $25. prov_name std_hosp ord_prov_name $70. prov_id $25. epi_id adm_id $16 mdst_place_grp_cd table $12.;
...
/* Admissions *; 
 data amex.adm;
   infile  "/data/amex/adm_amex.csv" dlm = ',' missover dsd firstobs = 2 lrecl = 120;
...
* MEG *;
data amex.meg;
  infile  "/data/ames/meg_amex.csv" dlm = ',' missover dsd firstobs = 2 lrecl = 200;
...
proc sort data=amex.elig out = amex.elig_trim (keep = enrolid year dtstart employer_cd sex age zip_cd state_cd msa_cd years_svc salary_ind 
  ...
  by enrolid dstart; 
run;
data amex.elig_trim (drop = year dtstart);
  set amex.elig_trim;
  by enrolid dtstart;
...
%macro by_mbr(yr);
  data amex.claims_&yr._1 (keep = enrolid age sex opioid1 naloxone1 buprenorphine1 methadone1 short_acting1 long_acting1
    ...
    * set flags by member *;
    retain opioid1 naloxone1 buprenorphine1 methadone1 short_acting1 long_acting1 fentanyl1 benzodiazepine1 naltrexone1 
      ...
      bad_pot1 good_pot1 barbiturate1 muscle1 bup_meht_nalt1 morphine1 trinity 
...
* QA *;
proc freq data=amex.claims2016_1;
...
data amex.new_users2016;
  merge amex.new_users2016 (in=nin)
        amex.claims2017_1 (in=xinp1 keep = enrolid cancer1 hospice1 rename = (cancer1 = cancerp1 hospice1 = hospicep1))
        amex.claims2016_1 (in=xin0  keep = enrolid cancer1 hospice1)
        amex.claims2015_1 (in=xinm1 keep = enrolid cancer1 hospice1 rename = (cancer1 = cancerm1 hospice1 = hospicem1));
  by enrolid;
  if nin;
